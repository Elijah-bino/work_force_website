...
<body>
    <div class="sidebar">
        ...
        <div class="content">
            ...
            $bookingsQuery = "SELECT * FROM bookings WHERE service_provider_id = $serviceProviderId AND order_status = 'incomplete' AND order_request_status is null ";
            ...
            if ($result) {
                ...
                echo "<table>";
                echo "<tr><th>User ID</th><th>Booking ID</th><th>User Name</th><th>User Email</th><th>Booking Time</th><th>Action</th></tr>";
                    ...
                    if ($userResult) {
                        ...
                        echo '<td>
                                        ...
                                        <div class="action-buttons">
                                            <form method="POST" action="service_provider_order_accepted.php">
                                                <input type="hidden" name="booking_id" value="' . $row["booking_id"] . '">
                                                <input type="hidden" name="user_id" value="' . $row["users_id"] . '">
                                                <button type="submit" class="accept-button" name="accept_booking">Accept</button>
                                            </form>
                                            <form method="POST" action="service_provider_order_rejected.php">
                                                <input type="hidden" name="booking_id" value="' . $row["booking_id"] . '">
                                                <button type="submit" class="reject-button" name="reject_booking">Reject</button>
                                            </form>
                                        </div>
                                    </td>';
                                echo "</tr>";
