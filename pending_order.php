...
<body>
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<td>
                            <form method="post" action="">
                                ...
                                <button type="button" class="complete-button" onclick="toggleFeedbackForm(' . $row["booking_id"] . ')">Completed</button>
                            </form>
                            <div class="feedback-form" id="feedbackForm_' . $row["booking_id"] . '">
    ...
    function toggleFeedbackForm(bookingId) {
        var feedbackForm = document.getElementById('feedbackForm_' + bookingId);
